...
RSpec.describe "Sessions API", type: :request do
  ...
  let(:headers)do
  {
    'Accept' => 'application/api.taskmanager.v2',
  ...
  describe 'POST /sessions' do
    ...
    context "when the credentials are correst" do
    ...
    context "when the credentials are incorrest" do
      let(:credentials){{email:user.email, password: 'password_invalid'}}
